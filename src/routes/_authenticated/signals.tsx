          ...
          {PAIRS.map((p) => {
            ...
            return (
              <Card key={p} className="p-4">
                ...
                <Button asChild size="sm" className="w-full mt-3 font-semibold">
                  <Link to="/trade">
                    Trade {p.replace("USDT", "")} ({bull ? "Buy / Long" : "Sell / Short"})
                  </Link>
                </Button>
              </Card>
            );
